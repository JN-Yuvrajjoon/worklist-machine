				...
				<div class="col-md-3" id="wm-input-column">
					<div class="shadow rounded-lg">
						<ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
							...
							{/* Courses tab */}
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="courses-tab" data-toggle="tab" href="#courses-menu" role="tab" aria-controls="courses" aria-selected="false">Courses</a>
							</li>

							{/* About tab */}
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="about-tab" data-toggle="tab" href="#about-menu" role="tab" aria-controls="about" aria-selected="false">About</a>
							</li>
						...
						<div class="tab-content p-3" id="myTabContent">
							...
							<div class="tab-pane fade show active" id="#settings-menu" role="tabpanel" aria-labelledby="settings-menu"> 
								settings
							</div>
							
							<div class="tab-pane fade" id="c#ourses-menu" role="tabpanel" aria-labelledby="courses-menu">
								courses
							</div>
